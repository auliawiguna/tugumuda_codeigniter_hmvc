...
<head>
    ...
    <link href="<?= base_url('tugumuda/images/icon.png') ?>" rel='icon' type='image/x-icon'/>

    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.6 -->
    <link rel="stylesheet" href="<?=base_url('tugumuda/css/bootstrap.min.css')?>">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?=base_url('tugumuda/css/font-awesome.min.css')?>">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?=base_url('tugumuda/css/ionicons.min.css')?>">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?=base_url('tugumuda/css/AdminLTE.min.css')?>">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="<?=base_url('tugumuda/css/_all-skins.min.css')?>">
...
<!-- jQuery 2.2.0 -->
<script src="<?=base_url('tugumuda/plugins/jQuery/jquery-1.11.0.min.js')?>"></script>
<!-- Bootstrap 3.3.6 -->
<script src="<?=base_url('tugumuda/js/bootstrap.min.js')?>"></script>
<!-- AdminLTE App -->
<script src="<?=base_url('tugumuda/js/app.min.js')?>"></script>
<!-- Sparkline -->
<!-- SlimScroll 1.3.0 -->
<script src="<?=base_url('tugumuda/plugins/slimScroll/jquery.slimscroll.min.js')?>"></script>

<!--Legacy Framework Mbiyen-->
<script type="text/javascript" src="<?=base_url('tugumuda/js/moment.js')?>"></script>
<link rel="stylesheet" href="<?=base_url('tugumuda/css/bootstrap-datetimepicker.min.css')?>" />
<script type="text/javascript" src="<?=base_url('tugumuda/js/bootstrap-datetimepicker.min.js')?>"></script>

<!--NOTINY-->
<script type="text/javascript" src="<?=base_url('tugumuda/plugins/notiny/notiny.min.js')?>"></script>
<link rel="stylesheet" href="<?=base_url('tugumuda/plugins/notiny/notiny.min.css')?>">
<!--NOTINY-->

<!--CKEDITOR-->
<script type="text/javascript" src="<?=base_url('tugumuda/plugins/ckeditor/ckeditor.js')?>"></script>
<script type="text/javascript" src="<?=base_url('tugumuda/plugins/ckeditor/adapters/jquery.js')?>"></script>
<!--CKEDITOR-->

<!-- fileinput -->
	<link rel="stylesheet" href="<?= base_url('tugumuda/css/fileinput.min.css') ?>" />
	<script type="text/javascript" src="<?= base_url('tugumuda/js/fileinput.min_optimized.js') ?>"></script>
<!-- fileinput -->

<script type="text/javascript" src="<?=base_url('tugumuda/plugins/Material-Preloader/js/materialPreloader.min.js')?>"></script>

<link rel="stylesheet" type="text/css" href="<?=base_url('tugumuda/plugins/Material-Preloader/css/materialPreloader.min.css')?>">


<!--    TABS  -->
<script type="text/javascript" src="<?=base_url('tugumuda/js/bootstrap-tab.min.js')?>"></script>
<!--    TABS  -->


<!--    VALIDATION-->
<link rel="stylesheet" href="<?= base_url('tugumuda/plugins/validation-engine/css/validationEngine.jquery.css') ?>" type="text/css"/>
<script src="<?= base_url('tugumuda/plugins/validation-engine/js/jquery.validationEngine-id.js') ?>" type="text/javascript" charset="utf-8"></script>
<script src="<?= base_url('tugumuda/plugins/validation-engine/js/jquery.validationEngine.js') ?>" type="text/javascript" charset="utf-8"></script>
<!--    VALIDATION-->

<!--    TABLE-->
<link rel="stylesheet" href="<?= base_url('tugumuda/plugins/tablefix/tablefix.css') ?>" type="text/css"/>
<script src="<?= base_url('tugumuda/plugins/tablefix/tablefix.js') ?>" type="text/javascript" charset="utf-8"></script>
    <!--    TABLE-->


<script src="<?= base_url('tugumuda/plugins/font-awesome/fontawesome-iconpicker.js') ?>" type="text/javascript" charset="utf-8"></script>
<link rel="stylesheet" href="<?= base_url('tugumuda/plugins/font-awesome/fontawesome-iconpicker.min.css') ?>" type="text/css"/>


<script type="text/javascript" src="<?= base_url('tugumuda/plugins/AmaranJS/js/jquery.amaran.min.js') ?>"></script>

<link rel="stylesheet" href="<?= base_url('tugumuda/plugins/select2/select2.min.css') ?>" />
<script type="text/javascript" src="<?= base_url('tugumuda/plugins/bootbox/bootbox.min.js') ?>"></script>
<script type="text/javascript" src="<?= base_url('tugumuda/plugins/select2/select2.full.min.js') ?>"></script>
<script type="text/javascript" src="<?= base_url('tugumuda/plugins/mask/jquery.maskedinput.js') ?>"></script>
<script type="text/javascript" src="<?= base_url('tugumuda/plugins/maskMoney/jquery.maskMoney.min.js') ?>"></script>
<script type="text/javascript" src="<?= base_url('tugumuda/js/claravel.js') ?>"></script>

<script src="<?= base_url('tugumuda/plugins/fullcalendar/fullcalendar.min.js')?>"></script>
<script src="<?= base_url('tugumuda/plugins/chartjs/Chart.min.js')?>"></script>
    ...
    $('#profil_user2').on('click',function(e){
        ...
        //      formatSelection: tmlhrFormatSelection
            ...
            function loading(elemen){
                $('#' + elemen + '').html("<center><img src='<?=base_url('tugumuda/images/loading.gif')?>'></center>");
            }
            function loading_kecil(elemen){
                elemen.html("<center><img src='<?=base_url('tugumuda/img/loading_kecil.gif')?>'></center>");
            }
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=url('')?>/dashboard" class="logo">
      ...
      <span class="logo-lg"><b>Tugumuda</b> 5.4</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?=base_url('packages/upload/photo/'.session('user_id').'/'.session('foto'))?>" class="img-circle" alt="User Image">
